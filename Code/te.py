...
cnx = mysql.connector.connect(user='aniket19',password='Anilraji95*', database='PP1_real_time')
cursor = cnx.cursor()
...
for stock_name in stock_names:
	...
	with open('A:/'+stock_name+'.csv', 'w',newline='') as outcsv:
	...
	for r in range(len(realtime_data)):
			...
			#print(temp_data)
			with open('A:/'+stock_name+'.csv', 'a',newline='') as outcsv:
