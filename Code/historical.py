...
cnx = mysql.connector.connect(user='root',password='Anilraji95*',database='PP1_historical')
cursor = cnx.cursor()
...
for stock_name in stock_names:
	...
	with open('A:/'+stock_name+'historical_.csv', 'w',newline='') as outcsv:
	...
	for h in range(len(historical_data)):
		...
		#print(temp_data)
		with open('A:/'+stock_name+'historical_.csv', 'a',newline='') as outcsv:
